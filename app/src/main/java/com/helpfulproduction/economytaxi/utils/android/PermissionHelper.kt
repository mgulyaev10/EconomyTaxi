package com.helpfulproduction.economytaxi.utils.android
...
import com.helpfulproduction.economytaxi.utils.Navigator
...
object PermissionHelper {
    ...
    fun rememberDeniedPermission(context: Context?, permission: String) {
        ...
        Preference.setDeniedPermission(
            context,
            permission
        )
    }
    ...
    private fun dontAskAgainPermission(activity: Activity?, permission: String): Boolean {
        ...
        return !ActivityCompat.shouldShowRequestPermissionRationale(activity, permission) && Preference.isAlreadyDeniedPermission(
            activity,
            permission
        )
    }
